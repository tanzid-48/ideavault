      ...
      <div className="w-full min-h-screen bg-gray-50 dark:bg-zinc-950 flex items-center justify-center px-4">
        <div className="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-3xl p-10 flex flex-col items-center gap-4 max-w-sm w-full text-center shadow-sm">
          ...
          <p className="text-sm text-gray-400 dark:text-zinc-500">
            Please login to view your profile, ideas, and interactions.
          </p>
          <Link
            href="/login"
  ...
  const quickLinks = [
    {
      ...
      hover:
        "hover:bg-indigo-50 dark:hover:bg-indigo-950/30 hover:border-indigo-200 dark:hover:border-indigo-800",
    },
    {
      href: "/myInteractions",
      ...
      hover:
        "hover:bg-sky-50 dark:hover:bg-sky-950/30 hover:border-sky-200 dark:hover:border-sky-800",
    },
    {
      href: "/savedIdeas",
      icon: FiBookmark,
      ...
      hover:
        "hover:bg-amber-50 dark:hover:bg-amber-950/30 hover:border-amber-200 dark:hover:border-amber-800",
    },
  ];
              ...
              {quickLinks.map(
                ({ href, icon: Icon, label, color, bg, border, hover }) => (
                  ...
                  >
                    ...
                    <span
                      className={`text-[10px] font-semibold ${color} text-center leading-tight`}
                    >
                      {label}
                    </span>
                  </Link>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-3xl p-5">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-sm font-bold text-gray-900 dark:text-white flex items-center gap-2">
              <HiOutlineLightBulb className="h-4 w-4 text-indigo-500" /> Recent
              Ideas
            </h2>
            <Link
              href="/ideas"
