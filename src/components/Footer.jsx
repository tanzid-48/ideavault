...
const Footer = () => {
  ...
  const footerLink =
    "text-sm text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors font-medium";
    ...
    <footer className="bg-indigo-100/30 border-t border-gray-100 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-300 font-medium leading-relaxed">
              The ultimate vault for groundbreaking startup ideas. Secure,
              collaborate, and grow your innovation with the community.
            </p>
          </div>
          <div className="space-y-3">
            ...
            <ul className="space-y-2 flex flex-col">
              ...
              <li>
                <Link href="/ideas" className={footerLink}>
                  Explore Ideas
                </Link>
              </li>
              <li>
                <Link href="/addIdea" className={footerLink}>
                  Add New Idea
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-100 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex space-x-6 text-xs text-gray-500 dark:text-gray-400 font-medium">
            <Link
              href="/privacy"
